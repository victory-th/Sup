    ...
    workspace = {
      ...
      onCreate = {
        install-and-prebuild = ''
          npm ci --prefer-offline --no-audit --no-progress --timing && npm i @expo/ngrok@^4.1.0 react@latest react-dom@latest react-native@latest && npm i -D @types/react@latest && npx -y expo install expo-dev-client && npx -y expo prebuild --platform android
